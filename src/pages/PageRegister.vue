              ...
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.avatar.$error" class="form-error">
                    <span v-if="!$v.form.avatar.url" class="help is-danger">Ikke korrekt url format</span>
                    <span v-if="!$v.form.avatar.supportedFileType" class="help is-danger">Ikke gyldig filtype</span>
                  </div>                             
                </div>
              </div>
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.password.$error" class="form-error">
                    ...
                    <span v-if="!$v.form.password.minLength" class="help is-danger">Password minimumlength is 6 letters</span>
                  </div>
                </div>
              </div>
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.passwordConfirmation.$error" class="form-error">
                    <span v-if="!$v.form.passwordConfirmation.required" class="help is-danger">Password does not match</span>
                    <span v-if="!$v.form.passwordConfirmation.sameAsPassword" class="help is-danger">Password må være lik</span>
                  </div>                         
                </div>
              </div>
    ...
    methods: {
      register () {
        ...
        this.$store.dispatch('auth/registerUser', this.form)
          ...
          .catch(errMessage => {
            this.$toasted.error(errMessage, {duration: 2000})
            })
      }
    }
  }
